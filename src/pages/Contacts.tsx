...
export function Contacts() {
  return (
    <section className="min-h-[calc(100vh-9rem)] flex flex-col items-center py-20 px-12 font-poppins">
      <p className="text-center text-sm sm:text-base">O Espaço Nandi fica no shopping <b>Map Band</b>, na Estrada dos Bandeirantes 8591, sala 327.</p>
      <p className="text-center text-sm sm:text-base mt-1">Jacarepaguá. Rio de Janeiro. RJ Cep 22783-115 (na altura do Riocentro, no shopping do McDonald's)</p>
      <br />
      <div className="flex flex-col md:flex-row gap-12 text-sm sm:text-base mt-4">
