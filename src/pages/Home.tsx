export function Home() {
  return (
    <div className="flex flex-col justify-center min-h-[calc(100vh-9rem)] w-full bg-gray-200 font-poppins">
      <section className="w-full h-[calc(100vh-5rem)] flex flex-col items-center justify-center relative bg-[url('/assets/background.webp')] bg-no-repeat bg-cover bg-center z-0">
        <div className="h-full w-full bg-black bg-opacity-85 absolute top-0 bottom-0 left-0 right-0 z-10">{' '}</div>
        <h1 className="md:block hidden text-white text-center lg:text-[2vw] md:text-3xl text-2xl font-semibold z-20 animate-fadeInLeft">ESPAÇO NANDI | FORMAÇÃO DE ATORES</h1>
        <h1 className="md:hidden block text-white text-center text-2xl font-semibold z-20 animate-fadeInLeft">ESPAÇO NANDI <br /> FORMAÇÃO DE ATORES</h1>
        <img src="/assets/cover.webp" alt="Background cover" className="w-[85%] md:w-fit mt-16 z-20 animate-fadeInLeft" />
      ...
      <section className="flex flex-col items-center justify-center min-h-screen sm:gap-24 gap-12 py-16">
        ...
        <div className="flex md:flex-row flex-col items-center max-w-[1080px] lg:gap-16 gap-12 px-12">
          <img src="/assets/ittala.webp" alt="Ittala" className="h-72 md:h-80" />
