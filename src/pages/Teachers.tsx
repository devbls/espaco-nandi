    ...
    <section className="min-h-[calc(100vh-6rem)] flex flex-col items-center py-20 px-12 font-poppins">
      ...
      <div className="max-w-[1280px] flex flex-col gap-24 md:gap-16 mt-16">
        {TEACHERS.map((teacher, index) => (
          <div className={`flex ${index % 2 === 0 ? 'md:flex-row animate-fadeInBottom md:animate-fadeInLeft' : 'md:flex-row-reverse animate-fadeInBottom md:animate-fadeInRight'} flex-col gap-8 items-center`}>
